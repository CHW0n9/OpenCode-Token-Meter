...
#### Windows
1. Download `OpenCodeTokenMeter-1.1.2.exe` from [GitHub Releases](https://github.com/chw0n9/opencode-token-meter/releases).
2. Run the executable to start the application. The app will appear in your system tray.

#### macOS
1. Download `OpenCodeTokenMeter-1.1.2.dmg` from [GitHub Releases](https://github.com/chw0n9/opencode-token-meter/releases).
